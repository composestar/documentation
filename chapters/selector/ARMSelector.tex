...
\dotnetcomment{\input{chapters/selector/ARMSelectorDotNETComment}}
%\javacomment{}
%\ccomment{}
%\pending{}
\furtherreading{
In \cite{Havinga2005} the new selector language is introduced. The considerations on the chosen design and the implementation can be found there.
}